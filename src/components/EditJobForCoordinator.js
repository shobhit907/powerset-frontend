...
export default function EditJobForCoordinator() {
  ...
  const handleSubmit = () => {
    ...
    axios({
      method: "put",
      url: "https://powerset-backend.herokuapp.com/placements/job-profiles/"+job_id+"/",
      headers: {
  ...
  const getData = () => {
    ...
    axios({
      method: "get",
      url:
        "https://powerset-backend.herokuapp.com/placements/job-profiles/" +
        job_id.toString() +
        "/",
      headers: {
        Authorization: token,
            ...
            <Grid container spacing={4} alignContent="center">
              ...
              <Grid item xs={12} sm={6} alignContent="center">
                ...
                >
                  ...
                  <MenuItem value={"non-core"}>
                    Non Core (Banking/Finance etc)
                  </MenuItem>
              ...
              <Grid item xs={12} sm={6}>
                ...
                <FormGroup column>
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={eligibleBatches.firstYear}
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={eligibleBatches.secondYear}
                        onChange={handleBatch}
                        name="secondYear"
                      />
                    }
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={eligibleBatches.thirdYear}
                        onChange={handleBatch}
                        name="thirdYear"
                      />
                    }
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={eligibleBatches.fourthYear}
                        onChange={handleBatch}
                        name="fourthYear"
                      />
                    }
              ...
              <Grid item xs={12} sm={6}>
                ...
                <FormGroup column>
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={eligibleBranches.civil}
                        onChange={handleBranch}
                        name="CE"
                      />
                    }
